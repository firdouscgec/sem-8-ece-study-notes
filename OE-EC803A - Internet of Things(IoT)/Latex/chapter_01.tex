...
\section{Section 7: Categories of IoT by Scope (Q1.9) [5M][]}
...
\subsection{1. Personal IoT}
\begin{itemize}
  \item   \textbf{Definition:} Consumer-centric IoT applications designed for individual users to enhance personal convenience, health, or lifestyle. It represents the primary \textbf{Business-to-Consumer (B2C)} process in IoT.
  \item   \textbf{Characteristics:} High focus on user experience, ease of installation, and mobile integration.
  \item   \textbf{Examples:} Smartwatches (e.g., Apple Watch, Fitbit), home voice assistants (e.g., Amazon Alexa), and smart home appliances.
\end{itemize}

\subsection{2. Group IoT}
\begin{itemize}
  \item   \textbf{Definition:} IoT solutions deployed within a shared, localized group environment (e.g., offices, schools, small business facilities) to improve collective convenience or resource utilization.
  \item   \textbf{Characteristics:} Medium scale, shared user access control, localized network setup.
  \item   \textbf{Examples:} Connected smart office lighting, shared smart printers, centralized HVAC systems in corporate buildings, and smart classroom boards.
\end{itemize}

\subsection{3. Community IoT}
\begin{itemize}
  \item   \textbf{Definition:} Large-scale deployments designed to benefit citizens within a localized region or municipality. It is a key driver for smart cities, allowing citizens to interact with and contribute data to public infrastructure.
  \item   \textbf{Characteristics:} High scale, public-private partnerships, public data availability, focus on citizen safety and mobility.
  \item   \textbf{Examples:} Air quality monitoring networks, citizen-reported smart parking updates, municipal waste fill trackers, and public bicycle sharing grids.
\end{itemize}

\subsection{4. Industrial IoT (IIoT)}
\begin{itemize}
  \item   \textbf{Definition:} High-reliability systems deployed in factories, power grids, logistics, and supply chains to optimize operational efficiency, automate processes, and monitor assets.
  \item   \textbf{Characteristics:} Mission-critical, extreme security standards, real-time deterministic performance requirements, low latency, and zero-downtime tolerance.
  \item   \textbf{Examples:} Predictive maintenance of turbines, factory floor robotic monitoring, cold-chain temperature tracking, and smart grid sub-station monitors.
\end{itemize}
